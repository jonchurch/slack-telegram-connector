...
telegram_botkit.handleWebhookPayload = function(req, bot) {
            ...
            if (telegram_message.message) {
              ...
              console.log(telegram_message.message.from)
                var message = {
                    text: telegram_message.message.text,
                    user: telegram_message.message.from.id,
                    profile: {
                      username: telegram_message.message.from.username,
                      fn: telegram_message.message.from.first_name,
                      ln: telegram_message.message.from.last_name
                    },
                    channel: telegram_message.message.chat.id,
